...
## Project Structure
    ...
    ├── the_journey_podcast_38088  # Django project configurations
...
1. Clone this repo and `cd the_journey_podcast_38088`
...
2. Clone this repo and `cd the_journey_podcast_38088`
